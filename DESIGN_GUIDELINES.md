...
- **Primary**
  ...
  - 用途: ブランドの軸、信頼感、主要見出し、重要なUI

- **Accent**
  - Color: `#14B8A6` (Teal)
  - 用途: CTA、選択状態、能動的アクション、ハイライト
...
### ルール2: Accent（Teal）は “行動” にだけ使う

Accent をなんでもかんでも `Teal` にしない。
...
使いすぎると安っぽく見えるため、**1画面の中で「最も押してほしい要素」だけに使う。**
...
- **Logo / Site Name**: `#1F2A44`
- **Header Border**: `#E2E8F0`
- **Header Action Button**: `#14B8A6`
...
- **信頼感** は **ネイビー（Primary）** で作る
- **行動導線** は **ティール（Accent）** で作る
- **情報整理** は **グレーと余白** で作る
